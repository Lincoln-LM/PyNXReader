...
from rng import XOROSHIRO,CryptoPatchRNG,OverworldState,Filter
...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        setup_styles()
        self.master.title("Crypto Patched RNG")
        ...
        self.genderless_var = tk.IntVar()
        self.genderless_var.set(0)
        ttk.Checkbutton(self, text="Genderless", variable=self.genderless_var).grid(column=column,row=5)
    ...
    def generate(self):
        ...
        self.predict = CryptoPatchRNG(
            ...
            filter = filter,
            genderless=self.genderless_var.get()
            )
        if self.min_shown:
    ...
    def patch(self, address, asm):
        self.SWSHReader.write_main(address & 0xFFFFFFFF, binascii.a2b_hex(asm.replace(" ", "")).hex())
    ...
    def connect(self):
        ...
        self.patch(0x71007667dc,"54 f5 00 d0")
        self.patch(0x71007667e0,"94 26 44 f9")
        self.patch(0x71007667e4,"94 02 40 f9")
        self.patch(0x71007667e8,"94 4e 40 f9")
        self.patch(0x71007668F0,"1f 20 03 d5")
